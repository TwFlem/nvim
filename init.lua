...
vim.keymap.set('n', '<C-W>t', '<cmd>tabnew<cr>', { desc = 'New Empty [T]ab' })
vim.keymap.set('n', '<C-c>', '<cmd>noh<cr>', { desc = 'Clear Last Search' })
...
vim.keymap.set('n', '<leader>sH', function() require('telescope.builtin').find_files({hidden = true }) end, { desc = '[S]earch Filed including [H]idden' })
